...
;
; CALLING SEQUENCE:
;       MYREADCOL, name, v1, [ v2, v3, v4, v5, ...  v300 , COMMENT=
...
;-
  ...
  if N_params() lt 2 then begin
     print,'Syntax - MYREADCOL, name, v1, [ v2, v3,...v300, '
